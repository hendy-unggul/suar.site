...
type Putaran = {
  ...
  warna_target: string
  objek: string[]
  warna_netral_distractor: string[]
}
...
export default function GameDuniaWarnaTapTarget({ childId, childName, colors, onSessionComplete }: Props) {
